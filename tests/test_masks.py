...
@pytest.mark.parametrize("number_account, result_mask_account",
...
@pytest.mark.parametrize("number_card, result_mask_card",
...
@pytest.mark.parametrize("number_card",
                         ["15968378 68705199", "159683786870", "", "1596837868705199123", "asdfgtretgfddrty"])
